...
// SLPodFrame
#define COCOAPODS_POD_AVAILABLE_SLPodFrame
#define COCOAPODS_VERSION_MAJOR_SLPodFrame 0
#define COCOAPODS_VERSION_MINOR_SLPodFrame 1
#define COCOAPODS_VERSION_PATCH_SLPodFrame 0
